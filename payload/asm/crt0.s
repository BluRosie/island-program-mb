...
_020180C0:
	...
	ldr r1, _02018200 @ =0x03007FFC
	add r0, pc, #0x18 @ =_intr
	str r0, [r1]
	ldr r1, _02018204 @ =sub_0201820C
	mov lr, pc
	bx r1

	arm_func_start sub_020180F0
...
_0201819C:
	...
	ldr r0, [r1]
	stmdb sp!, {lr}
	add lr, pc, #0x0 @ =_intr_ret
	bx r0

	arm_func_start _intr_ret
